...
class MyUtils
{
    ...
    {
        return coffees.stream().collect(
                Collectors.groupingBy(Caffee::getName,
...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        list.add(new Espresso("Espresso", 5));
        list.add(new Cappuccino("Cappuccino", 4));
        list.add(new Espresso("Espresso", 3));
        list.add(new Cappuccino("Cappuccino", 2));
        list.add(new Caffee("Caffee", 5));
